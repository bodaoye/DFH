...
/**
  ...
  * @retval 无
  */
static void LPFOfilter_init(LPFOfilter_t* pft,LPFO_initstruct* pftinit)
{
...
LPFOfilter_t wheel_speed_filter0;
LPFOfilter_t wheel_speed_filter1;
LPFOfilter_t wheel_speed_filter2;
LPFOfilter_t wheel_speed_filter3;
...
{
    LPFO_initstruct LPFO_initstr0;
    LPFO_initstruct LPFO_initstr1;
    LPFO_initstruct LPFO_initstr2;
    LPFO_initstruct LPFO_initstr3;

    /*BR wheel*/
    LPFO_initstr0.mode        = LPFO_MODE_N;
    LPFO_initstr0.K           = 0.4f;
    LPFOfilter_init(&wheel_speed_filter0,&LPFO_initstr0);
  
    /*BL wheel*/
    LPFO_initstr1.mode        = LPFO_MODE_N;
    LPFO_initstr1.K           = 0.4f;
    LPFOfilter_init(&wheel_speed_filter1,&LPFO_initstr1);
  
    /*FR wheel*/
    LPFO_initstr2.mode        = LPFO_MODE_N;
    LPFO_initstr2.K           = 0.4f;
    LPFOfilter_init(&wheel_speed_filter2,&LPFO_initstr2);
  
    /*FL wheel*/
    LPFO_initstr3.mode        = LPFO_MODE_N;
    LPFO_initstr3.K           = 0.4f;
    LPFOfilter_init(&wheel_speed_filter3,&LPFO_initstr3);
